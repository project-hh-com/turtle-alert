...
const DEVIATION_THRESHOLD = {
  noseShoulderRatioDrop: 0.07,
  shoulderTiltIncrease: 0.03,
  headRotationConfidenceDiff: 0.3,
  shoulderWidthIncrease: 0.15,
  headTiltIncrease: 0.03,
  noseCenterOffset: 0.05,
  slouchRatioDrop: 0.05,
  earForwardRatioDrop: 0.07,
};
